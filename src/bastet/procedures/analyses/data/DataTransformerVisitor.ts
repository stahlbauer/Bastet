...
abstract class TransformingVisitor<
    RT,
...
export class DataNumExpressionVisitor<
    B extends AbstractBoolean,
    I extends AbstractInteger,
    R extends AbstractReal,
    F extends AbstractFloat,
    ...
    implements CoreNumberExpressionVisitor<AbstractNumber>
{
    visitCastExpression(node: CastExpression): AbstractNumber {
        ...
        if (node.toConvertFrom.expressionType == StringType.instance()) {
            ...
            if (node.castToType == IntegerType.instance()) {
                return this._theories.intTheory.ifThenElse(
                    node.toConvertFrom.accept(boolVisitor),
                    this._theories.intTheory.one(),
                    this._theories.intTheory.zero()
                );
            } else {
                throw new IllegalArgumentException();
            }
...
export class DataBoolExpressionVisitor<
    B extends AbstractBoolean,
    I extends AbstractInteger,
    R extends AbstractReal,
    F extends AbstractFloat,
    ...
    implements CoreBoolExpressionVisitor<B>
{
    ...
    visitStrContainsExpression(node: StrContainsExpression): B {
        ...
        return this._theories.stringTheory.stringContains(
            node.operand1.accept(strVisitor) as S,
            node.operand2.accept(strVisitor) as S
        );
    }
...
export class DataStringExpressionVisitor<
    B extends AbstractBoolean,
    I extends AbstractInteger,
    R extends AbstractReal,
    F extends AbstractFloat,
...
export class DataListExpressionVisitor<
    B extends AbstractBoolean,
    I extends AbstractInteger,
    R extends AbstractReal,
    F extends AbstractFloat,
...
export class DataTransformerVisitor<
    B extends AbstractBoolean,
    I extends AbstractInteger,
    R extends AbstractReal,
    F extends AbstractFloat,

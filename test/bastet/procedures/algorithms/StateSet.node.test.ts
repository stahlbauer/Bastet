...
describe('DifferencingFrontierSet', function () {
    test('Lexy Key', function () {
        ...
        assert.deepStrictEqual(s.pop(), e2);
        assert.deepStrictEqual(s.pop(), e1);
        assert.deepStrictEqual(s.pop(), e4);
    ...
    test('Test One Partition', function () {
        ...
        assert.deepStrictEqual(s.getSize(), 3);
        s.remove(e1);
        assert.deepStrictEqual(s.getSize(), 2);
        s.remove(e1);
        assert.deepStrictEqual(s.getSize(), 2);
    ...
    test('Test Two Partitions', function () {
        ...
        assert.deepStrictEqual(s.getSize(), 5);
        s.removeAll([e1, e2, e3, e4]);
        assert.deepStrictEqual(s.getSize(), 1);
        assert.deepStrictEqual(s.peek(), e5);
        assert.deepStrictEqual(s.getSize(), 1);
        assert.ok(s.has(e5));
        s.remove(e5);
        assert.ok(!s.has(e5));
    ...
    test('Test Alternating Pop', function () {
        ...
        const first = s.peek();
        assert.deepStrictEqual(first, s.peek());
